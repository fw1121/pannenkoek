...
setup(
    ...
    scripts = ['pannenkoek/pannenkoek.py', 'pannenkoek/lefse/format_input.py', 'pannenkoek/lefse/run_lefse.py', 'pannenkoek/lefse/lefse.py', 'pannenkoek/pretty_lefse/prettylefse.R'],
